...
public class MultipartArchiveOpenCallback implements IArchiveOpenVolumeCallback, IArchiveOpenCallback {

    /**
     * Cache for opened file streams
     */
    private final Map<String, RandomAccessFile> openedRandomAccessFileList =
            new HashMap<>();
