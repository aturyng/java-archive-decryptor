...
class SevenZipBindingsHandlerTest {
    ...
    private enum FileType {
        SINGLE, MULTIPLE, SINGLE_ENCR_LIST
    }
    ...
    private void doTestWithFilesInside(String format, int nrFilesInside, FileType type) throws ZipHandler7ZipImpl.ExtractionException, WrongPassException, IOException {
        //GIVEN
    ...
    private void doTestWithMultipleFilesInside(String format) throws ZipHandler7ZipImpl.ExtractionException, WrongPassException, IOException {
    ...
    @Test
    void extractAll_pw_prot_7z_multiple_files_inside() throws ZipHandler7ZipImpl.ExtractionException, WrongPassException, IOException {
        this.doTestWithMultipleFilesInside("7z");
    }

    @Test
    void extractAll_pw_prot_zip_multiple_files_inside() throws ZipHandler7ZipImpl.ExtractionException, WrongPassException, IOException {
        this.doTestWithMultipleFilesInside("zip");
    }
    @Test
    void extractAll_pw_prot_rar_multiple_files_inside() throws ZipHandler7ZipImpl.ExtractionException, WrongPassException, IOException {
